...
# Render ko error se bachane ke liye Flask Dummy Server
app = Flask(__name__)
...
# Bot ko alag thread mein chalane ke liye function
def run_bot():
...
if __name__ == "__main__":
    ...
    # Render ke liye Flask server start karein (Port bind karne ke liye)
